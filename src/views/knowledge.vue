<template>
    <div class="knowledge-page">
        ...
        <el-table :data="tableData" style="width: 100%; margin-top: 25px">
            <el-table-column width="650" label="文章标题" fixed="left">
            ...
            <el-table-column prop="readCount" label="阅读量" width="180" align="center" />
...
const handleSearch = async (formData) => {
    ...
    console.log('📊 文章数据:', records[0])
    console.log('📊 阅读量字段值:', records[0]?.readCount)
