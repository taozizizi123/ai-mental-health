        ...
        <div class="content">
            ...
            <div class="diary-card">
                ...
                <div class="emotion-grid">
                    <div v-for="emotion in emotionOptions" :key="emotion.name" class="emotion-card" :class="{'selected': diaryForm.dominantEmotion === emotion.name}" @click="diaryForm.dominantEmotion = emotion.name">
