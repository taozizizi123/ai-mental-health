<template>
    <div>
        ...
        <el-table :data="tableData" style="width: 100%">
            ...
            <el-table-column label="情绪评分" width="400">
                <template #default="scope">
            ...
            <el-table-column prop="emotionTriggers" label="情绪触发因素" width="300" />
            <el-table-column prop="diaryContent" label="日记内容" width="400" />
